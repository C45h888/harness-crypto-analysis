...
# The pure positioning primitives live in
# ``market_service.calculations.substrates.positioning`` (moved verbatim,
# move-don't-rewrite); this module re-exports them as a DEPRECATED compat
# seam for historical import paths (same pattern as
# ``market_service/signals.py`` and ``analysis.wall_migration``).
from market_service.calculations.substrates.positioning import (  # noqa: F401
    find_walls,
    oi_implied_value,
    oi_inflow_outflow,
