"""Signals substrate — deterministic, explainable state-change signals.

Pure comparison of a snapshot against the previous snapshot. Deterministic
and bias-free; each signal records the values that caused it so conclusions
can be audited.
"""
